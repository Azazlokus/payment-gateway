...
Route::middleware(['correlation'])->group(function () {
    ...
    // Управление конкретным диспутом
    Route::prefix('disputes/{id}')->group(function () {
 ...
 * POST /crypto/deposits — create a new deposit address+memo
 * GET  /crypto/deposits/{id} — get deposit status
 */
Route::prefix('crypto')->middleware(['correlation'])->group(function () {
